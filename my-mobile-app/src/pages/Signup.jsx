...
  
  // Form data state (includes studentId and contact)
  const [formData, setFormData] = useState({
    fullName: "",
    email: "",
    password: "",
    confirmPassword: "",
    studentId: "", // Kept in state
    contact: "", // Kept in state
  });
...
  // Form validation: Only mandatory fields are validated
  const validateForm = () => {
...
    try {
      // Send all form data, optional fields will be empty strings if not filled
...
        }}
      />
      {/* Optional Tag for Contact Number */}
      <p
        className="absolute text-gray-500"
        style={{ 
          right: "10vw", 
