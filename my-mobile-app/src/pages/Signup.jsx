...
export default function Signup() {
  ...
  return (
    <div className="w-screen h-screen relative bg-white font-poppins">
      ...
      <h1 className="absolute font-black text-black" style={{ left: "8vw", top: "26.5vh", fontSize: "7vw" }}>Create an account</h1>
      <p className="absolute font-semibold text-[#36570A]" style={{ left: "8.5vw", top: "30vh", fontSize: "3.5vw" }}>Please enter your details</p>
      ...
      <InputField top="37vh" icon={userIcon} type="text" field="fullName" placeholder="Full Name" formData={formData} handleInputChange={handleInputChange} />
      <InputField top="44vh" icon={emailIcon} type="email" field="email" placeholder="Email Address" formData={formData} handleInputChange={handleInputChange} />
      <InputField top="51vh" icon={studentIcon} type="text" field="studentId" placeholder="Student ID" formData={formData} handleInputChange={handleInputChange} />
      <InputField top="58vh" icon={contactIcon} type="tel" field="contact" placeholder="Contact Number" formData={formData} handleInputChange={handleInputChange} />
      <InputField top="65vh" icon={passwordIcon} type="password" field="password" placeholder="Password" toggle={showPassword} onToggle={() => setShowPassword(!showPassword)} formData={formData} handleInputChange={handleInputChange} />
      <p className="absolute text-gray-600" style={{ left: "8vw", top: "71.2vh", fontSize: "2.8vw" }}>Password must be 8-16 characters</p>
      <InputField top="73.5vh" icon={passwordIcon} type="password" field="confirmPassword" placeholder="Confirm Password" toggle={showConfirm} onToggle={() => setShowConfirm(!showConfirm)} formData={formData} handleInputChange={handleInputChange} />

      <button
        className="absolute rounded-lg text-white font-bold disabled:opacity-50 disabled:cursor-not-allowed"
        style={{ top: "81vh", left: "7vw", width: "86vw", height: "6vh", backgroundColor: "#36570A", fontSize: "3.5vw" }}
