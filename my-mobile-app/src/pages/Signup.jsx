...
export default function Signup() {
  ...
  return (
    <div className="w-screen h-screen relative bg-white font-poppins">
      ...
      <p className="absolute text-gray-600" style={{ left: "8vw", top: "61.7vh", fontSize: "2.8vw" }}>Password must be 8-16 characters</p>
      <InputField top="64.2vh" icon={passwordIcon} type="password" field="confirmPassword" placeholder="Confirm Password" toggle={showConfirm} onToggle={() => setShowConfirm(!showConfirm)} formData={formData} handleInputChange={handleInputChange} />

      <button
        className="absolute rounded-lg text-white font-bold disabled:opacity-50 disabled:cursor-not-allowed"
        style={{ top: "73.2vh", left: "7vw", width: "86vw", height: "6vh", backgroundColor: "#36570A", fontSize: "3.5vw" }}
